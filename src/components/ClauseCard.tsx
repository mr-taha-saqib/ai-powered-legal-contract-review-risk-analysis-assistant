      ...
      {isExpanded && (
        <div className="px-4 pb-4 space-y-4 border-t border-gray-100">
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <h4 className="text-xs font-medium text-blue-900 uppercase mb-2">
              Plain Language
            </h4>
          ...
          {clause.isOverride && clause.overrideJustification && (
            <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
              <h4 className="text-xs font-medium text-amber-900 uppercase mb-1">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm text-blue-600 hover:bg-blue-50 rounded-lg transition-colors w-full justify-center font-medium"
          >
